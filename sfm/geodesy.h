...
#ifndef SFM_GEODESY_H
#define SFM_GEODESY_H
 ...
 **/
                ...
                )
        {
            ...
            return math::Vec3d(E * 1000, N * 1000, alt);
        }
...
// http://fr.mathworks.com/matlabcentral/newsreader/view_thread/142629
                ...
                )
        {
            ...
            return math::Vec3d(R2D(lat), R2D(lon), alt);
        }
